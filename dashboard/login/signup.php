...
$iffalse="../login/signup.html";
    ...
    if(isset($_POST['submit']))
    {
        ...
        {sql("INSERT INTO admin (admin_name,admin_num,admin_email,admin_password) VALUES ('$name','$number','$email','$password')");}
        else {sql("INSERT INTO users (user_name,user_num,user_email,user_password,user_school) VALUES ('$name','$number','$email','$password','$school')");}
