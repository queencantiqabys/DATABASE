                    ...
                    <tr>
                      <td>
                        <div class="d-flex px-2">
                          ...
                          <div class="my-auto">
                            <h6 class="mb-0 text-sm">Wardana</h6>
                          </div>
                        </div>
                      </td>
                      <td>
                        <p class="text-sm font-weight-bold mb-0">14 Juli 2003</p>
                      </td>
                      <td>
                      ...
                      <td class="align-middle text-center">
                        <div class="d-flex align-items-center justify-content-center">
                          ...
                          <div>
                            <div class="progress">
                              <div class="progress-bar bg-gradient-primary" role="progressbar" aria-valuenow="100" aria-valuemin="0" aria-valuemax="100" style="width: 20%;"></div>
                            </div>
                          </div>
                        </div>
                      </td>
